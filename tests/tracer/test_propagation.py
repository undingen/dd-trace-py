...
from ddtrace.propagation.http import HTTP_HEADER_B3_SAMPLED
from ddtrace.propagation.http import HTTP_HEADER_B3_SINGLE
from ddtrace.propagation.http import HTTP_HEADER_B3_SPAN_ID
from ddtrace.propagation.http import HTTP_HEADER_B3_TRACE_ID
...
B3_HEADERS_VALID = {
    HTTP_HEADER_B3_TRACE_ID: "463ac35c9f6413ad48485a3953bb6124",
    HTTP_HEADER_B3_SPAN_ID: "a2fb4a1d1a96d312",
    HTTP_HEADER_B3_SAMPLED: "1",
}
B3_HEADERS_INVALID = {
    HTTP_HEADER_B3_TRACE_ID: "NON_HEX_VALUE",
    HTTP_HEADER_B3_SPAN_ID: "NON_HEX",
    HTTP_HEADER_B3_SAMPLED: "3",  # unexpected sampling value
}
B3_SINGLE_HEADERS_VALID = {
    HTTP_HEADER_B3_SINGLE: "80f198ee56343ba864fe8b2a57d3eff7-e457b5a2e4d86bd1-1",
}
B3_SINGLE_HEADERS_INVALID = {
    HTTP_HEADER_B3_SINGLE: "NON_HEX_VALUE-e457b5a2e4d86bd1-1",
}
...
EXTRACT_FIXTURES = [
    ...
    (
        ...
        [PROPAGATION_STYLE_B3_SINGLE_HEADER],
        {HTTP_HEADER_B3_SINGLE: B3_SINGLE_HEADERS_VALID[HTTP_HEADER_B3_SINGLE] + "-05e3ac9a4f6e3b90-extra-data-here"},
        {
            "trace_id": 7277407061855694839,
            "span_id": 16453819474850114513,
            "sampling_priority": 1,
...
INJECT_FIXTURES = [
    ...
    (
        ...
        [PROPAGATION_STYLE_B3_SINGLE_HEADER],
        VALID_DATADOG_CONTEXT,
        {HTTP_HEADER_B3_SINGLE: "b5a2814f70060771-7197677932a62370-1"},
    ),
    (
    ...
    (
        ...
        {HTTP_HEADER_B3_SINGLE: "b5a2814f70060771-7197677932a62370"},
    ),
    # All styles
    (
        "valid_all_styles",
